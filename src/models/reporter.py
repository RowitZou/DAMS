...
class Statistics(object):
    ...
    * elapsed time
    ...
    def __init__(self, loss=0, n_words=0, n_correct=0,
        ...
        self.n_src_words = 0
        self.start_time = time.time()
        self.adv_enc_loss = adv_enc_loss
        self.adv_dec_loss = adv_dec_loss
    ...
    def update(self, stat, update_n_src_words=False):
        ...
        self.adv_enc_loss += stat.adv_enc_loss
        self.adv_dec_loss += stat.adv_dec_loss
    ...
    def get_adv_enc_loss(self):
        """ compute loss for encoder discriminators """
        return self.adv_enc_loss

    def get_adv_dec_loss(self):
        """ compute loss for decoder discriminators """
        return self.adv_dec_loss
    ...
    def output(self, step, num_steps, learning_rate, start):
        ...
        logger.info(
            ("Step %2d/%5d; acc: %6.2f; ppl: %5.2f; xent: %4.2f; " +
             "advenc loss: %5.2f; advdec loss: %5.2f; lr: %7.8f; %3.0f/%3.0f tok/s; %6.0f sec")
            % (step, num_steps,
               self.accuracy(),
               self.ppl(),
               self.xent(),
               self.get_adv_enc_loss(),
               self.get_adv_dec_loss(),
               learning_rate,
    ...
    def log_tensorboard(self, prefix, writer, learning_rate, step):
        ...
        writer.add_scalar(prefix + "/adv_enc_loss", self.get_adv_enc_loss(), step)
        writer.add_scalar(prefix + "/adv_dec_loss", self.get_adv_dec_loss(), step)
